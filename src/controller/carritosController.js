...
Ticket: <b>${newTicket.code}</b> - importe a pagar: <b><i>$ ${totalAmount}</b></i> <br>
Contacte a pagos para finalizar la operación: pagos@miecommerce.com
<br><br>
${productosSinStock.length>0?`Algunos items del carrito no fueron procesados. Verifique: ${JSON.stringify(productosSinStock, null, 5)}`:""}`
